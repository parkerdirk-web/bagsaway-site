...
export async function handler(event) {
  ...
  const custHtml =
    ...
    step('1', 'Come to K2 Gym', '27–29 Cliff Road, Newquay, TR7 2NE. The luggage store is on the <b>ground floor, just inside the front door</b>.') +
    step('2', 'Ring the bell &amp; message us', 'At the ground-floor entrance, ring the bell and give us a call or WhatsApp on <a href="https://wa.me/447763901135" style="color:#21395E;font-weight:bold;text-decoration:none">07763 901135</a>.') +
    step('3', 'We come down &amp; tag your bags', 'A staff member will greet you, tag each item and hand you a matching tag — keep it safe, it\'s how you collect.') +
    step('4', 'Go enjoy Newquay, hands-free', 'Come back any time before we close, show your tag and grab your things. That\'s it! 🏄') +
    '</table>' +
    // map
